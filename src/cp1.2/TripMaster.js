            ...
            <div className="welcome-content">
              ...
              <div className="welcome-features">
                <div className="feature-card">
                  ...
                  <p>Create and manage beautiful destinations around the world</p>
                </div>
                
                <div className="feature-card">
                  <div className="feature-icon">🏝️</div>
                  <h3>Vacation Plans</h3>
                  <p>Design perfect vacation packages for your customers</p>
                </div>
                ...
                <div className="feature-card">
                  ...
                  <p>Simple and efficient vacation booking management</p>
                </div>
              </div>
